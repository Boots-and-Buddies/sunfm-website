    ...
    <main className="h-screen overflow-hidden bg-[#EEEADA] flex flex-col items-center justify-center px-4 -mt-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <Image
          ...
          width={925}
          height={411}
          className="mx-auto h-auto w-auto max-w-[280px] md:max-w-[350px] mb-6"
          priority
        />

        {/* Coming Soon Badge */}
          <div className="inline-flex items-center gap-2 bg-[#FFD140] text-black px-4 py-2 rounded-full text-sm font-bold mb-2">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-2">
            A Premier Private Studio
            <br />
            <span className="text-[#CB4538]">Opening in San Jose</span>
          </h1>

          {/* Subheadline */}
          <p className="text-base md:text-lg text-gray-700 mb-6 max-w-xl mx-auto leading-relaxed">
            Tailored personal training focused on functional movement, mobility,
            and longevity. Experience a higher standard of fitness in the South Bay.
          </p>
          ...
          {/* Location Card - same width as email input */}
          <a
            href="https://maps.app.goo.gl/19dXxEMB8WddyoyJ6"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 shadow-md hover:shadow-lg transition-shadow mb-4 max-w-md mx-auto"
          >
          ...
          <div className="flex items-center justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gray-600 text-white rounded-full flex items-center justify-center hover:bg-[#FFD140] hover:text-black transition-colors"
      ...
      {!showLogin && (
        <button
          ...
          className="fixed bottom-4 right-4 text-gray-400 text-xs hover:text-gray-600 transition-colors opacity-30 hover:opacity-100 z-50"
        >
          Admin
        </button>
      )}
